	...
	public void onCreate(Bundle savedInstanceState) {
		...
		if (savedInstanceState == null ) {
			...
			if(isFirstCreate){
				...
				sp.edit().putBoolean("isFirstCreate", false).commit();
			}
		} else {
...
////					LockPatternUtils.getInstance(getApplicationContext()).setSavedPatternExists(false);
////				}
//				finish();
//			} else {
//				throw new IllegalStateException(
...
//		}
	...
	private void saveChosenPatternAndFinish() {
		LockPatternUtils.getInstance(getApplicationContext()).saveLockPattern(
				mChosenPattern);
		//showToast("密码设置成功");
		if(GesturesLock.clistener!=null){
			GesturesLock.clistener.callback();
