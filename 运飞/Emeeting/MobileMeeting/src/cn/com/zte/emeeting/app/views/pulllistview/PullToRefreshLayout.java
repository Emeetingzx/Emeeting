...
public class PullToRefreshLayout extends RelativeLayout
{
	 ...
	 * 是否允许加载更多
	 */
	public void isPullUp(boolean isPullUp)
	{
		isLoadMore = isPullUp;
	}
	 ...
	 * 是否允许下拉刷新
	 */
	public void isPullDown(boolean isPullDown)
	{
		isRefresh = isPullDown;
	}
	...
	private void initView()
	{
		...
		contentLayout = (LinearLayout) getChildAt(1);
		pullableView = (PullableListView) contentLayout.getChildAt(0);
	...
	protected void onLayout(boolean changed, int l, int t, int r, int b)
	{
		...
		contentLayout.layout(0, (int) (pullDownY + pullUpY),
				contentLayout.getMeasuredWidth(), (int) (pullDownY + pullUpY)
						+ contentLayout.getMeasuredHeight());
		loadmoreView.layout(0,
				(int) (pullDownY + pullUpY) + contentLayout.getMeasuredHeight(),
	...
	public void setDisLoadMore(boolean enable){
		pullableView.setCanLoadMore(enable);
	}
	...
	public void setAdapter(BaseAdapter adapter) {
		...
		this.pullableView.setAdapter(adapter);
	}
