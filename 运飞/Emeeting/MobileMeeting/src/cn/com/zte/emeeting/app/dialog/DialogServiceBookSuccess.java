 ...
 * @author wf
 */
public  class DialogServiceBookSuccess extends Dialog {
	 ...
	 * @param @param context
	 */
	public DialogServiceBookSuccess(Context context,String title,OnBookSuccessDlgListener listener) {
	...
	private void initView() {
		setContentView(R.layout.dialog_service_book_success);
