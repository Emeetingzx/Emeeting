 ...
 *
 */
public class GetMeetingJoinInfoRequest extends AppHttpRequest{
	 ...
	 */
	public GetMeetingJoinInfoRequest(Context context, boolean httpsFlag,String meetingid) {
		super(context, httpsFlag);
		setWebServiceMethod(HttpUtil.MeetingControl);
		setC(HttpUtil.GetMeetingJoinInfo);
	 ...
	 * @param meetingid	会议ID
	 */
	public GetMeetingJoinInfoRequest(Context context,String meetingid) {
