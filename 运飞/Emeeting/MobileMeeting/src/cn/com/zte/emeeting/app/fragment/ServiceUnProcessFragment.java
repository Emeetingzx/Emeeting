 ...
 * @author LangK
 */
public class ServiceUnProcessFragment extends BaseFragment{
...
//	private PullableListView pullableListView;
	 ...
	 * 页面标志
	 */
	public static final int FLAG = 0x111;
	/**
	 * 列表为空时显示该布局
	 */
...
//		filter.addAction(BroadcastUtil.AVServiceUndoNotifi);
//		mContext.registerReceiver(selfReceiver, filter);
	...
	protected void initData() {
		...
		addValueService.getUnProcessAddValueService(handler, pageInput);
