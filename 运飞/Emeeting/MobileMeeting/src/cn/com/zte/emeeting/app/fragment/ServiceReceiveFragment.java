 ...
 *
 */
public class ServiceReceiveFragment extends BaseFragment{
...
//	private PullableListView pullableListView;
	 ...
	 * 页面标志
	 */
	public static final int FLAG = 0x222;
	/**
	 * 列表为空时显示该布局
	 */
...
//		baseListViewLayout = (BaseListViewLayout) view.findViewById(R.id.service_myself_baselistview);
		...
		filter.addAction(BroadcastUtil.AVServiceReceiveNotifi);
	...
	protected void initData() {
		...
		addValueService.getReceiveAddValueService(handler, pageInput);
...
//					baseListViewLayout.setLVAdapter(adapter);
