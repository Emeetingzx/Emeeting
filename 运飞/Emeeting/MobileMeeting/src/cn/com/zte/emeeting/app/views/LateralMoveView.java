 ...
 * @author sun.li
 * */
public class LateralMoveView extends RelativeLayout {
	...
	public LateralMoveView(Context context) {
		super(context);
		init(context);
	}
	...
	public LateralMoveView(Context context, AttributeSet attrs) {
		super(context, attrs);
		init(context);
	}

	public LateralMoveView(Context context, AttributeSet attrs, int defStyle) {
	...
	public void setCenterView(View view) {
		mCententBut = (Button) view.findViewById(R.id.center_btn);
		
		if (mCententBut!=null) {
			mCententBut.setOnClickListener(new OnClickListener() {
...
//		return true;
	...
	void smoothScrollTo(int dx) {
		...
		if (oldScrollX==0) {
			if (mCententBut!=null) {
				mCententBut.setVisibility(View.VISIBLE);
			}
		}else {
			if (mCententBut!=null) {
				mCententBut.setVisibility(View.GONE);
			}
		}
	...
	public void showLeftView() {
		...
		int oldScrollX = mSlidingView.getScrollX();
		int	scrollX = -menuWidth-oldScrollX;
		mMenuView.setVisibility(View.VISIBLE);
		mDetailView.setVisibility(View.INVISIBLE);
