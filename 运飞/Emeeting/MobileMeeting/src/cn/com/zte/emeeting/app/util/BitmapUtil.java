...
//		o.inSampleSize = computeSampleSize(o, -1, 128*128);
	...
	public static Bitmap getBmp(File file,int width,int height) throws FileNotFoundException {
		if (file == null)
			return null;
		if (!file.exists()) {
			return null;
        ...
        int rote = computeSampleSize(o, minSideLength,  
                width * height);
        o.inSampleSize = rote;  
		o.inJustDecodeBounds = false;
		Bitmap tmp=null;
	...
	/** 根据头像资源ID的变量名获取Field对象 */
//	public static int getHeadResourceId(String name) {
//		try {
//			/* 根据资源ID的变量名获取Field对象 */
//			Field field = R.drawable.class.getField("ico_head_"+name.trim());
//			/* 获取并返回资源ID的字段（静态变量）的值 */
//			return Integer.parseInt(field.get(null).toString());
//		} catch (Exception e) {
//			e.printStackTrace();
