 ...
 * @author wf
 */
public  class DlgServiceConfirmBook extends Dialog {
	 ...
	 * @param @param context
	 */
	public DlgServiceConfirmBook(Context context,String title,OnConfirmDlgListener listener) {
...
//		this.getWindow().setWindowAnimations(R.style.dlgAnimation_up);
	...
	/** 设置左侧标题 */
	public void setLeftTitleNoTitle(String titleLeft) {
		titleRight = mContext.getResources().getString(
				R.string.mymeeting_dlg_confirmbook_tmp);
		titleLeft = "<font color='#333333'>" + titleLeft + "</font>";
		titleRight = "<font color='#333333'>" + titleRight + "</font>";
		String titleWhole = titleLeft + titleRight;
		tv_title.setText(Html.fromHtml(titleWhole));
	}
}
