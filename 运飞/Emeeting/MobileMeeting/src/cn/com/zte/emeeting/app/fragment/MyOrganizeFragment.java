...
public class MyOrganizeFragment extends BaseFragment{
	private static final String TAG="MyOrganizeFragment";
	...
	private String meetingType =DataConst.MEETINGBTYPE_MYORGANIZED;
	
	
	@Override
	protected View onCreateView(BaseLayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
	
		return inflater.inflate(R.layout.fragment_myorganize_meeting,null);
	}
...
//				lv_my_booked_meetings.setEmptyView(tv_emptyview_lv);
			...
			{
//				refresh_listview.isPullUp(false);
			}
		};
