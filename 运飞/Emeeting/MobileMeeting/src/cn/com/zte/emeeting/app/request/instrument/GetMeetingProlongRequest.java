 ...
 *
 */
public class GetMeetingProlongRequest extends AppHttpRequest{
	 ...
	 */
	public GetMeetingProlongRequest(Context context, boolean httpsFlag,String meetingid) {
	 ...
	 * @param meetingid	会议ID
	 */
	public GetMeetingProlongRequest(Context context,String meetingid) {
